...
from utils.constants import LLM_WORKER_2_QUEUE, LLM_WORKER_3_QUEUE, OUTPUT_QUEUE
...
def send_message():
    ...
    mq_agent.publish_message(json.dumps(queue_message), LLM_WORKER_3_QUEUE)
...
def handler():
    ...
    mq_agent.add_consumer(callback, LLM_WORKER_2_QUEUE)
